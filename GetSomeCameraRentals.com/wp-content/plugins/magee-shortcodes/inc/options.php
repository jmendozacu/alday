...
$magee_shortcodes['heading'] = array(
	...
	'shortcode' => '[ms_heading style="{{style}}" color="{{color}}" border_color="{{border_color}}" text_align="{{text_align}}" font_weight="{{font_weight}}" font_size="{{font_size}}" margin_top="{{margin_top}}" margin_bottom="{{margin_bottom}}" border_width="{{border_width}}" class="{{class}}" id="{{id}}"]{{title}}[/ms_heading]',
...
$magee_shortcodes['icon'] = array(
	...
	'shortcode' => '[ms_icon icon="{{icon}}" size="{{size}}" color="{{color}}" class="{{class}}" id="{{id}}"]',
