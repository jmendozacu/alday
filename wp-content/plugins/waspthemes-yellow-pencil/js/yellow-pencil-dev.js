;(function($) {
    ...
    window.yellow_pencil_main = function() {
            ...
            $(".yp-anim-control-play").on("click",function(){
                ...
                var maxWidthDelayEmpty = 0;
                var maxWidth = Math.max.apply( null, $( '.yp-anim-process-inner' ).map( function () {
                    $(this).find(".yp-anim-process-bar-delay").each(function(){
                        if($(this).width() == 10){
                            maxWidthDelayEmpty++;
                        }
                    });
                ...
                maxWidthDelayEmpty = maxWidthDelayEmpty/10;
                var s = (parseFloat(maxWidth)/100)-(maxWidthDelayEmpty);
                ...
                var S_inMS = (s*1000);
                clearTimeout(yp_anim_player);

                var yp_anim_player = setTimeout(function(){
            ...
            $(document).on("click", ".yp-control-trash", function() {
                ...
                swal({
                  ...
                  closeOnConfirm: true
                    ...
                    that.parent(".yp-anim-process-bar").fadeOut(250);
                    that.parent(".yp-anim-process-bar").prev(".yp-anim-process-bar-delay").fadeOut(250);

                    setTimeout(function(){
                        
                        // Remove Animate
                        $("body").addClass("yp-animate-manager-mode");
                        var selector = that.parents(".yp-anim-process-bar-area").attr("data-selector-full");
                        yp_insert_rule(selector, "animation-name", 'none', '');
                        $("body").removeClass("yp-animate-manager-mode");

                        // remove elements
                        that.tooltip("destroy");
                        that.parent(".yp-anim-process-bar").prev(".yp-anim-process-bar-delay").tooltip("destroy").remove();
                        that.parent(".yp-anim-process-bar").tooltip("destroy").remove();

                        // Update all others CSS
                        yp_animate_updater();
            ...
            function yp_update_infos(type){
                ...
                // delete ex
                $(".info-element-general,.info-element-class-list").empty();
                ...
                if(type != 'element'){
                    ...
                    iframeBody.find('*:not(.yp-selected):not(.yp-selected-other):not(.yp-x-distance-border):not(.yp-y-distance-border):not(.hover-info-box):not(.yp-size-handle):not(.yp-edit-menu):not(.yp-selected-tooltip):not(.yp-tooltip-small):not(.yp-selected-handle):not([class^="yp-selected-boxed-"]):not([class^="yp-selected-others-"]):not(.ypdw):not(.ypdh):not(.yp-helper-tooltip):not(link):not(style):not(script):not(param):not(option):not(tr):not(td):not(th):not(thead):not(tbody):not(tfoot):visible').each(function(i){
                        ...
                        if(i < 20){ // Get only on first 20 elements. no need to more.
                            ...
                            if(typeof boxSizing !== typeof undefined && boxSizing !== false){
                    ...
                    if($("body").hasClass("yp-responsive-device-mode") == false){
                        ...
                        var containerWidth = maxWidth+'px';

                    }else{
                        var containerWidth = 'Unknown';
                    }

        
                    // Apply colors
                    $(ColoredEl).each(function(i){
                ...
                if($("body").hasClass("yp-content-selected")){
                    ...
                    // Tag name.
                    if(typeof selectedID !== typeof undefined && selectedID !== false){
                        if(selectedID != ''){
                        elementMain.append('<li><span class="typo-list-left">ID</span><span class="typo-list-right"><span>#'+selectedID+'</span></span></li>');
                        }
                    }
                    ...
                    if(typeof classesP !== typeof undefined && classesP !== false){

                        classesP  = $.trim(classesP);

                        if(classesP != ''){
                            if(classesP.indexOf(" ") != -1){

                                classesP = classesP.split(" ");
                    ...
                    if(typeof clone.attr("style") !== typeof undefined && clone.attr("style") !== false){
            ...
            function yp_anim_manager(){
                ...
                iframe.find('[data-rule="animation-name"]').each(function(iX){
                    ...
                    if(deviceName != ''){
                        deviceHTML = " <label data-toggle='tooltipAnim' data-placement='top' title='The Animate will play just on some screen sizes.' class='yp-device-responsive'>"+deviceName+"</label>";
                    }
                    ...
                    // Element Variables
                    if(iframe.find("."+selector.replace(/\W+/g, "")+"-animation-duration-style").length > 0){
                        animateTimeOr = $.trim(iframe.find("."+selector.replace(/\W+/g, "")+"-animation-duration-style").html().split("animation-duration:")[1].replace(/\{/g,"").replace(/\}/g,"").replace(/!important/g,""));
                    }

                    if(iframe.find("."+selector.replace(/\W+/g, "")+"-animation-delay-style").length > 0){
                        animateDelayOr = $.trim(iframe.find("."+selector.replace(/\W+/g, "")+"-animation-delay-style").html().split("animation-delay:")[1].replace(/\{/g,"").replace(/\}/g,"").replace(/!important/g,""));
                    }
                    ...
                    var animateContent = "<div class='yp-anim-process-bar-delay' data-toggle='tooltipAnim' data-placement='top' title='Delay "+animateDelayOr+"' style='width:"+animateDelay+"px;'></div><div class='yp-anim-process-bar' data-toggle='tooltipAnim' data-placement='top' title='Duration: "+animateTimeOr+"' style='width:"+animateTime+"px;'><span class='animate-part-icons yp-control-trash' data-toggle='tooltipAnim' data-placement='top' title='Delete'><span class='dashicons dashicons-trash'></span></span>"+animateName+"</div>";
                    ...
                    if(animateName.indexOf(",") != -1){
                        ...
                        for(var i = 0; i < animateName.split(",").length; i++){
                            ...
                            if(animateDelayOr.toString().indexOf(",") != -1){
                                var childAnimateDelayOr = $.trim(animateDelayOr.split(",")[i]);
                            }else{
                                var childAnimateDelayOr = animateDelayOr;
                            }

                            // default is 1s for child animate delay Or.
                            if(childAnimateDelayOr == '' || childAnimateDelayOr == undefined){
                                childAnimateDelayOr = "0s";
                            }

                            if(animateDelay.toString().indexOf(",") != -1){
                                var childAnimateDelay = $.trim(animateDelay.split(",")[i]);
                            }else{
                                var childAnimateDelay = animateDelay;
                            }

                            // default is 1s for child animate delay.
                            if(childAnimateDelay == '' || childAnimateDelay == undefined){
                                childAnimateDelay = 0;
                            }

                            if(animateTimeOr.toString().indexOf(",") != -1){
                                var childAnimateTimeOr = $.trim(animateTimeOr.split(",")[i]);
                            }else{
                                var childAnimateTimeOr = animateTimeOr;
                            }

                            // default is 1s for child animate time Or.
                            if(childAnimateTimeOr == '' || childAnimateTimeOr == undefined){
                                childAnimateTimeOr = "1s";
                            }


                            if(animateTime.toString().indexOf(",") != -1){
                                var childAnimateTime = $.trim(animateTime.split(",")[i]);
                            }else{
                                var childAnimateTime = animateTime;
                            }

                            // default is 1s for child animate.
                            if(childAnimateTime == '' || childAnimateTime == undefined){
                                childAnimateTime = 1;
                            }
                            ...
                            animateContent += "<div class='yp-anim-process-bar-delay' data-toggle='tooltipAnim' data-placement='top' title='Delay "+smartDelayOrView+"' style='width:"+SmartDelayView+"px;'></div><div class='yp-anim-process-bar' data-toggle='tooltipAnim' data-placement='top' title='Duration: "+childAnimateTimeOr+"' style='width:"+childAnimateTime+"px;'><span class='animate-part-icons yp-control-trash' data-toggle='tooltipAnim' data-placement='top' title='Delete'><span class='dashicons dashicons-trash'></span></span>"+childAnimate+"</div>";

                            prevsBeforeAppend = prevsBeforeAppend + (childAnimateTime) + (childAnimateDelay);
                    ...
                    // Append.
                    $(".yp-anim-left-part-column").append("<div class='yp-anim-el-column'><span data-toggle='tooltipAnim' data-placement='top' title='"+selectorClean+"'>"+elementName+"</span> <label>"+modeName+"</label>"+deviceHTML+"</div>");
                    ...
                    $( "#yp-animate-bar-"+iX+" .yp-anim-process-bar-delay,#yp-animate-bar-"+iX+" .yp-anim-process-bar" ).resizable({
                        handles: 'e',
                        minWidth: 10,
                        ...
                        resize: function( event, ui ) {
                            ...
                            var s = ui.size.width/100;

                            if(that.hasClass("yp-anim-process-bar-delay") == false){
                                var newTitle = "Duration: "+s;
                            }else{
                                if(ui.size.width == 10){
                                    s = "0";
                                }
                                var newTitle = "Delay: "+s;
                            }
                ...
                $(".yp-animate-bar").each(function(){
                    ...
                    $(this).find(".yp-anim-process-bar,.yp-anim-process-bar-delay").each(function(){
                        ...
                        if($(this).hasClass("yp-anim-process-bar-delay") == true && $(this).parent().find(".yp-anim-process-bar-delay").length == 1){
                            ...
                            // Update one delay.
                            yp_insert_rule(selector, "animation-delay", s, 's');
                        ...
                        // If animate bar and not a multiable line.
                            ...
                            // Update one duration.
                            yp_insert_rule(selector, "animation-duration", s, 's');
                            yp_insert_rule(selector, "animation-name", $(this).text(), '');
                        ...
                        // If multi line and its delay or animate bar.
                                ...
                                // calcature time details.
                                if($(this).width() > 10){
                                    prevs += $(this).width()/100;
                                }else if($(this).width() < 10 && $(this).hasClass("yp-anim-process-bar")){
                                    prevs += $(this).width()/100;
                                }
                                ...
                                if($(this).hasClass("yp-anim-process-bar-delay")){
                                    ...
                                    // calcature time details.
                                    if($(this).width() > 10){
                                        sMulti.push(parseFloat(prevs+$(this).width()/100)+"s");
                                    }else{
                                        sMulti.push(prevs+"s");
                                    }
                            ...
                            if($(this).hasClass("yp-anim-process-bar")){
                                sMultiDuration.push(($(this).width()/100)+"s");
                    ...
                    // Insert multi delays.
                    if(sMulti.length > 1){
                        yp_insert_rule(selector, "animation-delay", sMulti.toString(), '');
                        yp_insert_rule(selector, "animation-duration", sMultiDuration.toString(), '');
                        yp_insert_rule(selector, "animation-name", sMultiNames.toString(), '');
                    }
            ...
            $(document).on("click", ".yp-anim-list-menu ul li", function(e) {
                ...
                if(p.parent().find(".yp-anim-process-inner").is(':empty')){
                    yp_insert_rule(selector, "animation-name", $(this).data("value"), '');
                }else{
                    ...
                    yp_insert_rule(selector, "animation-name",allAnimNames.toString(), '');
                }
            ...
            mainDocument.on("keydown", function(e) {
                ...
                if (code == 90 && ctrlKey == 1 && tagType == 0) {
                    ...
                    if ($("body").hasClass("yp-anim-creator")) {
                        swal("Sorry.",l18_cantUndo,"warning");
                        return false;
                    }
                ...
                if (code == 32 && ctrlKey == 0 && tagType == 0 && $("body").hasClass("yp-content-selected") == false && $(".yp-selector-mode").hasClass("active") == true) {
                    ...
                    if($("body").hasClass("yp-sharp-selector-mode-active")){
                        var selector = $.trim(yp_get_parents(iframe.find(".yp-selected"), "sharp"));
                    }else{
                        var selector = $.trim(yp_get_parents(iframe.find(".yp-selected"), "default"));
                    }
                ...
                if (code == 162 && ctrlKey == 0 && tagType == 0 && $("body").hasClass("process-by-code-editor") == false) {
                    ...
                    if ($("body").hasClass("yp-anim-creator")) {
                        swal("Sorry.",l18_cantEditor,"warning");
                        return false;
                    }
            ...
            $(".yp-after-css-val").keyup(function(e) {
                ...
                if(range.end == $(this).val().length && wasLast == false){
                    wasLast = true;
                    return true;
                }
            ...
            $(".yp-after-prefix").keyup(function(e) {
                ...
                if(range.end == 0 && wasLastPrefix == false){
                    wasLastPrefix = true;
                    return true;
                }
            ...
            $(".yp-button-live").click(function() {
                ...
                if ($("body").hasClass("yp-yellow-pencil-demo-mode")) {
                    swal("Sorry.",l18_live_preview,"info");
            ...
            function yp_create_anim() {
                ...
                if (iframe.find(".yp-anim-scenes style").length == 0) {
                    swal("Sorry.",l18_allScenesEmpty,"warning");
                    return false;
                }
            ...
            $(".yp-save-btn").on("click", function() {
                ...
                if (!$("body").hasClass("yp-yellow-pencil-demo-mode")) {
                    ...
                    swal("Sorry.",l18_demo_alert,"info");
                    $(".yp-save-btn").html(l18_saved).addClass("yp-disabled").removeClass("waiting-for-save");
            ...
            function yp_cssToData(type) {
                ...
                if (source.split('{').length != source.split('}').length) {
                    swal("Sorry.","CSS Editor: Parse Error.","error");
                    return false;
                }
            ...
            function yp_insert_rule(selector, id, value, prefix, size) {
                ...
                // If insert by animate manager
                if($("body").hasClass("yp-animate-manager-mode")){

                    // Get current animate line responsive data.
                    var sizeG = $(".yp-anim-process-bar-area[data-selector-full='"+selector+"']").attr("data-responsive");
                    
                    // Get it responsive or not.
                    if(sizeG != ''){
                        size = sizeG;
                    }
                    ...
                    if (value != 'disable' && value != 'none'){
                        ...
                        if(body.hasClass("yp-content-selected")){
                            ...
                            if (selector.replace(".yp_click", "").replace(".yp_hover", "").replace(".yp_focus", "").replace(".yp_onscreen", "") == yp_get_current_selector()){
                                ...
                                if(duration.toString().indexOf(",") != -1 && value.indexOf(",") == -1){
                                ...
                                if(delay.toString().indexOf(",") != -1 && value.indexOf(",") == -1){
                                    delay = delay.split(",")[0];
                                }else{
                                    parseFloat(delay);
                                }
            ...
            function yp_load_near_fonts(t){
               ...
               all.each(function() {
                    ...
                    if (typeof styleAttr !== typeof undefined && styleAttr !== false && styleAttr != ''){
                        return true;
                    }
            ...
            var totalFonts = $("#yp-autocomplete-place-font-family > ul li").length;
            ...
            function yp_clean() {
                ...
                if (body.hasClass("yp-content-selected") && iframeBody.find(".yp-selected").length > 0){
                    iframe.find(".yp-selected").draggable("destroy");
                }

                if(bodyX.find(".yp-anim-cancel-link").length > 0){
                    $(".yp-anim-cancel-link").trigger("click");
                }
                ...
                // Clean popovers.
                if(bodyX.hasClass("yp-content-selected")){
                ...
                body.removeAttr("data-clickable-select").removeAttr("data-yp-selector").removeClass("yp-selector-focus yp-selector-hover yp-css-data-trigger yp-contextmenuopen yp-content-selected yp-body-select-just-it yp-has-transform");
                ...
                if(bodyX.hasClass("yp-animate-manager-playing") == false){
            ...
            function yp_set_default(evt, $n, evt_status) {
                ...
                setTimeout(function() {
                    ...
                    if ($n == 'animation-play') {
                        ...
                        if (iframe.find('[data-style="' + elementID + yp_id(".yp_onscreen") + '"]').length > 0) {
                            data = 'yp_onscreen';
                        }

                        if (iframe.find('[data-style="' + elementID + yp_id(".yp_click") + '"]').length > 0) {
                            data = 'yp_click';
                        }

                        if (iframe.find('[data-style="' + elementID + yp_id(".yp_hover") + '"]').length > 0) {
                            data = 'yp_hover';
                        }

                        if (iframe.find('[data-style="' + elementID + yp_id(".yp_focus") + '"]').length > 0) {
                            data = 'yp_focus';
                        }
            ...
            var nonUsefulClass = [
                ...
                '([a-zA-Z0-9_-]+)?clearfix',
                '([a-zA-Z0-9_-]+)?clear',
                '([a-zA-Z0-9_-]+)?pull([_-])left',
                '([a-zA-Z0-9_-]+)?pull([_-])right',
                '([a-zA-Z0-9_-]+)?first',
                '([a-zA-Z0-9_-]+)?last',
                '([a-zA-Z0-9_-]+)?text([_-])left',
                '([a-zA-Z0-9_-]+)?text([_-])center',
                '([a-zA-Z0-9_-]+)?text([_-])right',
                ...
                // Column. Layout. ANY PREFIX.
                '([a-zA-Z0-9_-]+)?l([_-])[0-9]',
                '([a-zA-Z0-9_-]+)?m([_-])[0-9]',
                '([a-zA-Z0-9_-]+)?s([_-])[0-9]',
                '([a-zA-Z0-9_-]+)?xs([_-])[0-9]',
                '([a-zA-Z0-9_-]+)?pure([_-])(\w+)([_-])u([_-])[0-9]([_-])[0-9]',
                '([a-zA-Z0-9_-]+)?col([_-])(\w+)([_-])[0-9]',
                '([a-zA-Z0-9_-]+)?col([_-])(\w+)([_-])offset([_-])[0-9]',
                ...
                '([a-zA-Z0-9_-]+)?medium([_-])(\w+)([_-])[0-9]',
                '([a-zA-Z0-9_-]+)?large([_-])(\w+)([_-])[0-9]',
                '([a-zA-Z0-9_-]+)?small([_-])(\w+)([_-])[0-9]',
                ...
                '([a-zA-Z0-9_-]+)?text([_-])align?([a-zA-Z0-9_-]+)',
            ...
            function yp_get_best_class($element) {
                ...
                if (typeof id != 'undefined') {
                    ...
                    // If has "widget" term in classes, its is a widget element. dont select
                    // with the ID.
                    // support any theme prefix. 123455-widget 
                    if (classes != undefined && classes != null) {
                    ...
                    // for siteorigin plugin. YP not love Base64 based ids.
                    if ($.trim(id).indexOf("pgc-") != -1 && $.trim(id).match(/\d+/g)){
                        id = '';
                    }
                ...
                if ($.trim(best_classes) != '') {
                    ...
                    $.each(nonUsefulClass,function(i,v){
            ...
            function yp_get_parents(a, status) {
                ...
                if (body.hasClass("yp-sharp-selector-mode-active") == false && status == 'default') {
                    ...
                    var array = selector.split(window.separator);
                    var lastSelected = array[array.length-1];
                    var selectedInSelected = iframeBody.find(selector+window.separator+lastSelected).length;
                    ...
                    if(selectedInSelected > 0){
                        ...
                        selector = untilLast + " > " + lastSelected;
            ...
            iframe.find('a[href]').on("click", iframe, function(evt) {
                ...
                if ($(".yp-selector-mode.active").length == 0) {
                    ...
                    if (href.indexOf("#noAiming") > -1) {
                        swal("Sorry.","This link is not an wordpress page. You can't edit this page.","warning");
                        return false;
                    }
                    ...
                    if (href != null && href != '' && href.charAt(0) != '#' && href.indexOf("javascript:") == -1 && href.indexOf("yellow_pencil=true") == -1) {
                        ...
                        if (link_host != main_host) {
                            swal("Sorry.","This is external link. You can't edit this page.","warning");
                            return false;
                        }
                                    ...
                                    element.draggable({
                                        ...
                                        stop: function() {
                                            ...
                                            // Back To Orginal Style Attr.
                                                if (typeof window.styleAttr !== typeof undefined && window.styleAttr !== false && window.styleAttr != ''){
            ...
            function yp_create_smart_guides(){
                ...
                var element = iframeBody.find(".yp-selected");
            ...
            iframe.on("mouseup", iframe, function() {
                ...
                if (body.hasClass("yp-element-resizing")) {
                    ...
                    setTimeout(function() {
                        ...
                        if(window.exWidthX != null && window.ResizeSelectedBorder == 'left'){
                            yp_insert_rule(yp_get_current_selector(),"margin-left",parseFloat(element.css("margin-left")),'px');
                        }

                        if(window.exWidthY != null && window.ResizeSelectedBorder == 'top'){
