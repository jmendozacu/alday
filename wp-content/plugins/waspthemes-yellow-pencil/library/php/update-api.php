...
function yp_update_message(){
    ...
    if($isUpdate == 'true' && $lastCheckVer == YP_PLUGIN_VERSION && $available > YP_PLUGIN_VERSION && current_user_can("update_plugins") == true && YP_USERNAME != '' && YP_APIKEY != '' && YP_PURCHASE_CODE != ''){
        ...
        <div class="updated yp-update-info-bar">
            <p><?php _e("New update avaliable for Yellow Pencil. Please update plugin for new features and improvements.","yp"); ?> <a style="box-shadow:none !important;-webkit-box-shadow:none !important;-moz-box-shadow:none !important;" href="#" class="yp_update_link"><?php _e("Update Now!","yp"); ?></a></p>
        </div>
        <?php
        ...
        ?>
        <div class="updated yp-update-info-bar">
            <p><?php _e("New update available for Yellow Pencil! Please Verify your purchase for automatic update.","yp"); ?> <a style="box-shadow:none !important;-webkit-box-shadow:none !important;-moz-box-shadow:none !important;" href="<?php echo admin_url('options-general.php?page=yp-update-settings'); ?>"><?php _e("Verify Now!","yp"); ?></a></p>
        </div>
        <?php
...
function yp_settings(){ ?>
    ...
    <div class="postbox yp-settings-box">
        <div class="inside">
    <p style="font-weight:600;"><?php _e("Please fill all fields for activate your copy of Yellow Pencil and unlock automatic updates. Don't worry!<br> You will not lose your changes after updates.","yp"); ?> <?php _e('Need to <a target="_blank" href="http://waspthemes.com/yellow-pencil">Help?</a>','yp'); ?></p>
