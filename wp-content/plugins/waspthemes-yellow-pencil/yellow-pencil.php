...
function yp_yellow_penci_bar() {
    ...
    echo "<div class='yp-select-bar yp-disable-cancel'>
		...
		if(isset($_GET['yp_id']) == false && isset($_GET['yp_type']) == false){
			...
			}else if($category_page == '' && $tag_page == ''){
...
<body class="<?php echo $classesReturn; ?>">
	...
	<div class="yp-animate-manager">
		...
		<div class="yp-anim-left-part-column">
			<div class="yp-anim-manager-control">
				...
				<a class="yp-anim-control-btn yp-anim-control-pause" data-toggle='tooltipAnim' data-placement='top' title='Pause'><span class="dashicons dashicons-controls-pause"></span></a>
				<a class="yp-anim-control-btn yp-anim-control-play" data-toggle='tooltipAnim' data-placement='top' title='Play Animations'><span class="dashicons dashicons-controls-play"></span></a>
		...
		<div class="yp-anim-right-part-column">
			...
			<img src="<?php echo WT_PLUGIN_URL; ?>images/seconds-metric.png" class="yp-anim-metric" />
		</div>
		<div class="yp-clearfix"></div>
	</div>
	...
	<div class="top-area-btn-group">
		...
		<div data-toggle='tooltip-bar' data-placement='right' title='<?php _e('Responsive Mode','yp'); ?> <span class="yp-tooltip-shortcut"><?php _e('Edit for all screen sizes','yp'); ?></span>' class="top-area-btn yp-responsive-btn active"><span class="dashicons dashicons-smartphone"></span></div>
		...
		<div data-toggle='tooltip-bar' data-placement='right' title='<?php _e('Measuring Tool','yp'); ?> <span class="yp-tooltip-shortcut"><?php _e('Shortcut: R','yp'); ?></span>' class="top-area-btn yp-ruler-btn"><span class="dashicons dashicons-editor-removeformatting"></span></div>
		...
		<div data-toggle='tooltip-bar' data-placement='right' title='<?php _e('Fullscreen','yp'); ?> <span class="yp-tooltip-shortcut"><?php _e('Switch to full screen','yp'); ?></span>' class="top-area-btn fullscreen-btn"><span class="dashicons dashicons-editor-contract"></span><span class="dashicons dashicons-editor-expand"></span></div>
	...
	<script src='<?php echo esc_url(plugins_url( 'js/plugins.js?ver='.YP_VERSION.'' , __FILE__ )); ?>'></script>
