	...
	**/
	(function($)
	{
		...
		$(document).ready(function() {
				...
				$('.styleswitch[rel=header1]').click(function(){
				
				 $('.layout-theme').removeClass("layout-header2");
				 $('.layout-theme').removeClass("layout-header3");
				 $('.layout-theme').addClass("layout-header1");
				
				});
				
				
			
			$('.styleswitch[rel=header2]').click(function(){
				
				 $('.layout-theme').removeClass("layout-header1");
				 $('.layout-theme').removeClass("layout-header3");
				 $('.layout-theme').addClass("layout-header2");
				
				});
				
				
			$('.styleswitch[rel=header3]').click(function(){
				
				 $('.layout-theme').removeClass("layout-header1");
				 $('.layout-theme').removeClass("layout-header2");
				 $('.layout-theme').addClass("layout-header3");
	...
	jQuery('.demo_changer .demo-icon').click(function(){
		...
		if(jQuery('.demo_changer').hasClass("active")){
			jQuery('.demo_changer').animate({"left":"-155px"},function(){
