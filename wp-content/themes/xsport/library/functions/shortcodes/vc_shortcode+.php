	...
	vc_map( 
		array(
			...
			"params" => array(
				...
				isset($add_icon_libs) ? $add_icon_libs : '',
				isset($pix_fonts['pixflaticon']) ? $pix_fonts['pixflaticon'] : '',
				isset($pix_fonts['pixfontawesome']) ? $pix_fonts['pixfontawesome'] : '',
				isset($pix_fonts['pixelegant']) ? $pix_fonts['pixelegant'] : '',
				isset($pix_fonts['pixicomoon']) ? $pix_fonts['pixicomoon'] : '',
				isset($pix_fonts['pixsimple']) ? $pix_fonts['pixsimple'] : '',
				isset($pix_fonts['pixcustom1']) ? $pix_fonts['pixcustom1'] : '',
				isset($pix_fonts['pixcustom2']) ? $pix_fonts['pixcustom2'] : '',
				isset($pix_fonts['pixcustom3']) ? $pix_fonts['pixcustom3'] : '',
				isset($pix_fonts['pixcustom4']) ? $pix_fonts['pixcustom4'] : '',
				isset($pix_fonts['pixcustom5']) ? $pix_fonts['pixcustom5'] : '',
				isset($pix_fonts['fontawesome']) ? $pix_fonts['fontawesome'] : '',
				isset($pix_fonts['openiconic']) ? $pix_fonts['openiconic'] : '',
				isset($pix_fonts['typicons']) ? $pix_fonts['typicons'] : '',
				isset($pix_fonts['entypo']) ? $pix_fonts['entypo'] : '',
				isset($pix_fonts['linecons']) ? $pix_fonts['linecons'] : '',
